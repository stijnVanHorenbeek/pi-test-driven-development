...
test("matrix declares distinct model configurations and three repetitions", async () => {
...
test("matrix, cases, and templates are valid JSON inputs", async () => {
  for (const path of ["evals/matrix.json", "evals/cases.json", "evals/fixtures/templates.json"]) {
